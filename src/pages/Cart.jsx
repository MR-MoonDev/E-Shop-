      ...
      {cart.products.length > 0 ? (
        <div className="flex flex-col md:flex-row justify-between mt-8">
          <div className="md:w-2/3">
            ...
            <div className="flex flex-col border-b mb-4 text-xs font-bold">
              <div className=" flex justify-between items-center border-b font-extrabold  mb-4">
                <p>PRODUCTS</p>
        ...
        <div className="flex justify-center">
          <img src={Mackdata_image.Emptycart} alt="Empty cart" className="h-96" />
        </div>
      )}
    </div>
  );
